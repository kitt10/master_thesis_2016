...
if __name__ == '__main__':
    ...
    # Annotate
    '''
    plt.annotate('[784. 15. 2]', xy=(0, 11950), horizontalalignment='center', verticalalignment='center',
                 fontsize=11, color='darkblue')
    '''
    for step in pruning_steps:
        if step % 20 == 0 or step < 3:
            plt.annotate(str(kitt_xor['structure_mean'][step]), xy=(step+8.5, kitt_xor['n_syn_mean'][step] + 0.7 * kitt_xor['n_syn_mean'][step]),
