...
\section{Complete Feature Analysis for Terrains} \label{app:sec:complete_feature_analysis_for_terrains}
\begin{figure}[H]
  \centering
...
\begin{figure}[H]
  ...
  \caption{Pruning Algorithm Results on AMTER Dataset. IO power: thoraco.}
...
\begin{figure}[H]
  ...
  \caption{Pruning Algorithm Results on AMTER Dataset. IO power: coxa.}
...
\begin{figure}[H]
  ...
  \caption{Pruning Algorithm Results on AMTER Dataset. IO power: femur.}
