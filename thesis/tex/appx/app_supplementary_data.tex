...
\section{Sensory Data Examples} \label{app:sec:complete_sensory_data}
The following figures show signal examples for all $ 24 $ sensors (see \cref{tab:proprioceptors}).
\begin{figure}[H]
\centering
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_atl_f}
\end{subfigure}
\caption{Thoraco proprioceptive sensors, front legs}
\label{fig:app_at_f}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_acl_f}
\end{subfigure}
\caption{Coxa proprioceptive sensors, front legs}
\label{fig:app_ac_f}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_afl_f}
\end{subfigure}
\caption{Femur proprioceptive sensors, front legs}
\label{fig:app_af_f}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_atl_m}
\end{subfigure}
\caption{Thoraco proprioceptive sensors, middle legs}
\label{fig:app_at_m}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_acl_m}
\end{subfigure}
\caption{Coxa proprioceptive sensors, middle legs}
\label{fig:app_ac_m}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_afl_m}
\end{subfigure}
\caption{Femur proprioceptive sensors, middle legs}
\label{fig:app_af_m}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_atl_h}
\end{subfigure}
\caption{Thoraco proprioceptive sensors, hint legs}
\label{fig:app_at_h}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_acl_h}
\end{subfigure}
\caption{Coxa proprioceptive sensors, hint legs}
\label{fig:app_ac_h}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_afl_h}
\end{subfigure}
\caption{Femur proprioceptive sensors, hint legs}
\label{fig:app_af_h}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_fl_f}
\end{subfigure}
\caption{Tactile sensors, front legs}
\label{fig:app_f_f}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_fl_m}
\end{subfigure}
\caption{Tactile sensors, middle legs}
\label{fig:app_f_m}
\end{figure}
...
\begin{subfigure}{0.48\textwidth}
  ...
  \label{fig:app_fl_h}
\end{subfigure}
\caption{Tactile sensors, hint legs}
\label{fig:app_f_h}
\end{figure}

\newpage
\section{Generated Datasets} \label{app:sec:generated_datasets}
The following \cref{app:tab:generated_datasets} presents all generated datasets (see \cref{sec:dataset_creation}) used for terrain classification analysis (in \cref{sec:terrain_processing_results}).
...
\section{Supplementary Figures for Feature Analysis} \label{app:sec:supplementary_figures_for_feature_analysis}
Figures from this section complements the analysis of feature selection from \cref{ssec:pa_amter_feature_selection}.

\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{fs_used_features_coxa}
  \caption{Used features of coxa-trochanteral proprioceptive sensors for individual classes.}
...
\begin{figure}[H]
  ...
  \caption{Used features of femur-tibia proprioceptive sensors for individual classes.}
  \label{fig:pa_amter_used_features_femur}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{fs_amter_io_power_thoraco}
  \caption{Influence power of single features on classes: thoraco-coxa sensors}
  \label{fig:pa_amter_io_power_thoraco}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{fs_amter_io_power_coxa}
  \caption{Influence power of single features on classes: coxa-trochanteral sensors}
  \label{fig:pa_amter_io_power_coxa}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{fs_amter_io_power_femur}
  \caption{Influence power of single features on classes: femur-tibia sensors}
  \label{fig:pa_amter_io_power_femur}
\end{figure}
